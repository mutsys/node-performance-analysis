...
//
// load and start an performance metrics statsServer forked in a child process
// load and start performance metrics collectors
// give them function that they can call to send data to the statsServer
//
const { CpuStatsCollector, HeapStatsCollector, GcStatsCollector, QueueStatsCollector } = require("stats-server-collectors");
